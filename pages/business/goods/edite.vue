	...
	<view class="wrap">
		<view class="content">
			<u-form :model="form" ref="uForm" label-width="150">
				...
				<u-form-item label="产品描述" prop="">
					<u-input v-model="form.nickname" />
				</u-form-item>
				<u-form-item label="商品状态" prop="mobile">
					<u-input placeholder="请输入手机号" v-model="form.mobile" type="number"></u-input>
				</u-form-item>
				<u-form-item label="产品图片" prop="password">
					<Upload @on-upload-change="uploadChange" :list="fileList"></Upload>
					<!-- <u-input :password-icon="true" type="password" v-model="form.password" placeholder="请输入密码"></u-input> -->
				</u-form-item>
				<u-form-item label="质检报告" prop="password">
					<u-input :password-icon="true" type="password" v-model="form.password" placeholder="请输入密码"></u-input>
				</u-form-item>
